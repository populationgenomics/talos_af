...
start_download https://zenodo.org/records/15222100/files/gnomad_4.1_region_merged_GRCh38_whole_genome?download=1 \
  "${ECHTVAR_FILE}" "Downloading Echtvar from https://zenodo.org/records/15222100"
...
# REVEL raw data
REVEL="revel-v1.3_all_chromosomes.zip"
start_download "https://zenodo.org/records/7072866/files/revel-v1.3_all_chromosomes.zip?download=1" "${REVEL}"
